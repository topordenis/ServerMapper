...
struct LIMAGE_OPTIONAL_HEADER32 {
    ...
    LIMAGE_DATA_DIRECTORY DataDirectory [ NUM_DIR_ENTRIES ];
};
...
#define LIMAGE_FIRST_SECTION( m_pNTHeader ) ( ( LIMAGE_SECTION_HEADER* )        \
    ( ( ULONG_PTR ) ( m_pNTHeader ) +                                            \
     FIELD_OFFSET( LIMAGE_NT_HEADERS, OptionalHeader ) +                 \
